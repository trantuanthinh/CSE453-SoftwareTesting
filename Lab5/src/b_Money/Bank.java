...
public class Bank {
	 ...
	 * @param currency Base currency of this bank (If this is a Swedish bank, this
	 *                 might be a currency class representing SEK)
	 */
	 ...
	 */
	public Account openAccount(String accountid) throws AccountExistsException {
	...
	public void accountExists(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			throw new AccountExistsException();
		} else {
