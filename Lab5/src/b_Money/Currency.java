...
public class Currency {
	...
	/**
	 * New Currency The rate argument of each currency indicates that Currency's
	 * "universal" exchange rate. Imagine that we define the rate of each currency
	 * in relation to some universal currency. This means that the rate of each
	 * currency defines its value compared to this universal currency.
	 *
	 ...
	 * currency" (As mentioned in the documentation of the Currency constructor)
	 * 
